...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    static final /* synthetic */ boolean $assertionsDisabled = (!WindowDecorActionBar.class.desiredAssertionStatus() ? true : ALLOW_SHOW_HIDE_ANIMATIONS);
    ...
    public class TabImpl extends Tab {
        ...
        private int mPosition = WindowDecorActionBar.INVALID_POSITION;
        private Object mTag;
    ...
    private void init(View decor) {
        ...
        boolean homeAsUp = (this.mDecorToolbar.getDisplayOptions() & 4) != 0 ? true : ALLOW_SHOW_HIDE_ANIMATIONS;
        if (homeAsUp) {
            this.mDisplayHomeAsUpSet = true;
        }
        ActionBarPolicy abp = ActionBarPolicy.get(this.mContext);
        boolean z = (abp.enableHomeButtonByDefault() || homeAsUp) ? true : ALLOW_SHOW_HIDE_ANIMATIONS;
    ...
    private void setHasEmbeddedTabs(boolean hasEmbeddedTabs) {
        ...
        boolean isInTabMode = getNavigationMode() == 2 ? true : ALLOW_SHOW_HIDE_ANIMATIONS;
        ...
        boolean z2 = (this.mHasEmbeddedTabs || !isInTabMode) ? ALLOW_SHOW_HIDE_ANIMATIONS : true;
    ...
    public void setNavigationMode(int mode) {
        ...
        DecorToolbar decorToolbar = this.mDecorToolbar;
        boolean z2 = (mode != 2 || this.mHasEmbeddedTabs) ? ALLOW_SHOW_HIDE_ANIMATIONS : true;
        decorToolbar.setCollapsible(z2);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
