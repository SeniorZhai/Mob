...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int largestChildHeight = Action.UNDEFINED_DURATION;
        int i = SHOW_DIVIDER_NONE;
        while (i < count) {
            LayoutParams lp;
            int totalLength;
            ...
            if (child == null) {
                ...
                if (heightMode == 1073741824 && lp.height == 0 && lp.weight > 0.0f) {
                    ...
                    int oldHeight = Action.UNDEFINED_DURATION;
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int largestChildWidth = Action.UNDEFINED_DURATION;
        ...
        while (i2 < count) {
            ...
            if (child == null) {
                ...
                if (widthMode == 1073741824 && lp.width == 0 && lp.weight > 0.0f) {
                    ...
                    int oldWidth = Action.UNDEFINED_DURATION;
