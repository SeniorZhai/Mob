...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    static class SavedState implements Parcelable {
        ...
        SavedState(Parcel in) {
            ...
            this.mAnchorLayoutFromEnd = in.readInt() == StaggeredGridLayoutManager.VERTICAL ? true : StaggeredGridLayoutManager.DEBUG;
            if (in.readInt() != StaggeredGridLayoutManager.VERTICAL) {
                z = StaggeredGridLayoutManager.DEBUG;
            }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            int i = StaggeredGridLayoutManager.VERTICAL;
            ...
            dest.writeInt(this.mReverseLayout ? StaggeredGridLayoutManager.VERTICAL : StaggeredGridLayoutManager.HORIZONTAL);
            dest.writeInt(this.mAnchorLayoutFromEnd ? StaggeredGridLayoutManager.VERTICAL : StaggeredGridLayoutManager.HORIZONTAL);
    ...
    View hasGapsToFix() {
        ...
        int preferredSpanDir = (this.mOrientation == VERTICAL && isLayoutRTL()) ? VERTICAL : -1;
        if (this.mShouldReverseLayout) {
        ...
        while (i != childLimit) {
            ...
            if (!(lp.mFullSpan || i + nextChildDiff == childLimit)) {
                ...
                if (compareSpans) {
                    Object obj;
                    Object obj2 = lp.mSpan.mIndex - ((LayoutParams) nextChild.getLayoutParams()).mSpan.mIndex < 0 ? VERTICAL : HORIZONTAL;
    ...
    private boolean preferLastSpan(int layoutDir) {
        if (this.mOrientation == 0) {
            return (layoutDir == -1 ? true : HORIZONTAL) != this.mShouldReverseLayout ? true : DEBUG;
        } else {
            return ((layoutDir == -1 ? true : HORIZONTAL) == this.mShouldReverseLayout ? true : HORIZONTAL) != isLayoutRTL() ? DEBUG : true;
        }
    }
