...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private static final boolean IS_AT_LEAST_JB = (VERSION.SDK_INT >= 16 ? true : IS_AT_LEAST_M);
    private static final boolean IS_AT_LEAST_M = (VERSION.SDK_INT >= 23 ? true : IS_AT_LEAST_M);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mPopup != null && MeasureSpec.getMode(widthMeasureSpec) == Action.UNDEFINED_DURATION) {
