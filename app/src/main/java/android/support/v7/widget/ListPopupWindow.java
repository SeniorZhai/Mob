...
public class ListPopupWindow {
    ...
    public static abstract class ForwardingListener implements OnTouchListener {
        ...
        private final int[] mTmpLocation = new int[ListPopupWindow.INPUT_METHOD_NOT_NEEDED];
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (!wasForwarding) {
                forwarding = (onTouchObserved(event) && onForwardingStarted()) ? true : ListPopupWindow.DEBUG;
                if (forwarding) {
        ...
        private boolean onTouchForwarded(MotionEvent srcEvent) {
            ...
            boolean keepForwarding = (action == ListPopupWindow.POSITION_PROMPT_BELOW || action == 3) ? ListPopupWindow.DEBUG : true;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            int lastItem = Action.UNDEFINED_DURATION;
            if (adapter != null) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case com.mobcrush.mobcrush.R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case com.mobcrush.mobcrush.R.styleable.Toolbar_navigationIcon /*20*/:
                        case com.mobcrush.mobcrush.R.styleable.Toolbar_titleTextColor /*23*/:
                        case com.mobcrush.mobcrush.R.styleable.Theme_textColorSearchUrl /*66*/:
                            return true;
                    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            if (hintView != null) {
                ...
                hintView.measure(MeasureSpec.makeMeasureSpec(this.mDropDownWidth, Action.UNDEFINED_DURATION), POSITION_PROMPT_ABOVE);
        ...
        switch (this.mDropDownWidth) {
            case WRAP_CONTENT /*-2*/:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Action.UNDEFINED_DURATION);
                break;
            case MATCH_PARENT /*-1*/:
