...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - ChatFragment.MID_MUTE_TIME, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(ChatFragment.MID_MUTE_TIME + now, location.getLatitude(), location.getLongitude());
