...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.mCollapseMode = a.getInt(R.styleable.CollapsingAppBarLayout_LayoutParams_layout_collapseMode, COLLAPSE_MODE_OFF);
    ...
    private void showScrim() {
        if (!this.mScrimsAreShown) {
            if (!ViewCompat.isLaidOut(this) || isInEditMode()) {
                setScrimAlpha(SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
            } else {
                animateScrim(SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
            }
