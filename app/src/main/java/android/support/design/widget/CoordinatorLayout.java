...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        public int anchorGravity = CoordinatorLayout.TYPE_ON_INTERCEPT;
        public int gravity = CoordinatorLayout.TYPE_ON_INTERCEPT;
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.gravity = a.getInteger(R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.mAnchorId = a.getResourceId(R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = a.getInteger(R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
    ...
    private void prepareChildren() {
        ...
        for (i = TYPE_ON_INTERCEPT; i < childCount; i += TYPE_ON_TOUCH) {
