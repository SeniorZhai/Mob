...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        private final Paint mCirclePaint = new Paint(MaterialProgressDrawable.DEFAULT);
        ...
        Animation animation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (interpolatedTime <= MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) {
                    ring.setStartTrim(startingTrim + ((MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(interpolatedTime / MaterialProgressDrawable.START_TRIM_DURATION_OFFSET)));
                }
                if (interpolatedTime > MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) {
                    ring.setEndTrim(startingEndTrim + (MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((interpolatedTime - MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) / MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) * (MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc)));
                }
