...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    private float[] mMinimumVelocity = new float[]{RELATIVE_UNSPECIFIED, RELATIVE_UNSPECIFIED};
    ...
    private static class ClampedScroller {
        ...
        private int mDeltaX = AutoScrollHelper.HORIZONTAL;
        private int mDeltaY = AutoScrollHelper.HORIZONTAL;
