...
public class NotificationCompat {
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            private int mFlags = FLAG_AVAILABLE_OFFLINE;
    ...
    public static class Builder {
        ...
        String mCategory;
        int mColor = NotificationCompat.VISIBILITY_PRIVATE;
        ...
        int mVisibility = NotificationCompat.VISIBILITY_PRIVATE;
    ...
    public static final class CarExtender implements Extender {
        ...
        private int mColor = NotificationCompat.VISIBILITY_PRIVATE;
    ...
    public static final class WearableExtender implements Extender {
        ...
        private int mFlags = SIZE_XSMALL;
