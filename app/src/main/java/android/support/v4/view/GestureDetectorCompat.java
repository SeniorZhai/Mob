...
public class GestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            ...
            boolean pointerUp = (action & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) == 6;
            ...
            switch (action & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) {
                case LONGPRESS_TIMEOUT /*?: ONE_ARG  (wrap: int
  0x0000: INVOKE  (r0_0 int) =  android.view.ViewConfiguration.getLongPressTimeout():int type: STATIC)*/:
                ...
                case SHOW_PRESS /*1*/:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(Constants.UPDATE_COFIG_INTERVAL, (float) this.mMaximumFlingVelocity);
                ...
                case R.styleable.Toolbar_contentInsetEnd /*6*/:
                    ...
                    this.mLastFocusY = focusY;
                    this.mDownFocusY = focusY;
                    this.mVelocityTracker.computeCurrentVelocity(Constants.UPDATE_COFIG_INTERVAL, (float) this.mMaximumFlingVelocity);
