...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * DefaultLoadControl.DEFAULT_HIGH_BUFFER_LOAD)), Action.UNDEFINED_DURATION);
        int childHeightSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (getHeight() - getPaddingTop()) - getPaddingBottom()), Action.UNDEFINED_DURATION);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        childHeight -= padding;
        int childWidthSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) widthSize) * DefaultLoadControl.DEFAULT_HIGH_BUFFER_LOAD)), Action.UNDEFINED_DURATION);
        int childHeightSpec = MeasureSpec.makeMeasureSpec(Math.min(0, childHeight), Action.UNDEFINED_DURATION);
        this.mPrevText.measure(childWidthSpec, childHeightSpec);
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
