...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        public static final AccessibilityActionCompat ACTION_ACCESSIBILITY_FOCUS = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS, null);
        public static final AccessibilityActionCompat ACTION_CLEAR_ACCESSIBILITY_FOCUS = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, null);
        public static final AccessibilityActionCompat ACTION_CLEAR_FOCUS = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_WORD, null);
        public static final AccessibilityActionCompat ACTION_CLEAR_SELECTION = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_PARAGRAPH, null);
        public static final AccessibilityActionCompat ACTION_CLICK = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_PAGE, null);
        public static final AccessibilityActionCompat ACTION_COLLAPSE = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_COLLAPSE, null);
        public static final AccessibilityActionCompat ACTION_COPY = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_COPY, null);
        public static final AccessibilityActionCompat ACTION_CUT = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_CUT, null);
        public static final AccessibilityActionCompat ACTION_DISMISS = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_DISMISS, null);
        public static final AccessibilityActionCompat ACTION_EXPAND = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_EXPAND, null);
        public static final AccessibilityActionCompat ACTION_FOCUS = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_CHARACTER, null);
        public static final AccessibilityActionCompat ACTION_LONG_CLICK = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_LONG_CLICK, null);
        public static final AccessibilityActionCompat ACTION_NEXT_AT_MOVEMENT_GRANULARITY = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, null);
        public static final AccessibilityActionCompat ACTION_NEXT_HTML_ELEMENT = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT, null);
        public static final AccessibilityActionCompat ACTION_PASTE = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_PASTE, null);
        public static final AccessibilityActionCompat ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY, null);
        public static final AccessibilityActionCompat ACTION_PREVIOUS_HTML_ELEMENT = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_PREVIOUS_HTML_ELEMENT, null);
        public static final AccessibilityActionCompat ACTION_SCROLL_BACKWARD = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD, null);
        public static final AccessibilityActionCompat ACTION_SCROLL_FORWARD = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD, null);
        public static final AccessibilityActionCompat ACTION_SELECT = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_LINE, null);
        public static final AccessibilityActionCompat ACTION_SET_SELECTION = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_SET_SELECTION, null);
        public static final AccessibilityActionCompat ACTION_SET_TEXT = new AccessibilityActionCompat((int) AccessibilityNodeInfoCompat.ACTION_SET_TEXT, null);
