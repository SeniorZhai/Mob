...
public class JsonReader implements Closeable {
    ...
    private final char[] buffer = new char[AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT];
    private final Reader in;
    private boolean lenient = false;
    private int limit = PEEKED_NONE;
    private int lineNumber = PEEKED_NONE;
    private int lineStart = PEEKED_NONE;
    ...
    private int pos = PEEKED_NONE;
    private int[] stack = new int[32];
    private int stackSize = PEEKED_NONE;
    ...
    public double nextDouble() throws IOException {
        ...
        if (p == PEEKED_NUMBER) {
            ...
            this.peekedString = nextQuotedValue(p == PEEKED_SINGLE_QUOTED ? '\'' : TokenParser.DQUOTE);
