...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts, boolean is24HourMode, boolean disappearsOut) {
        ...
        this.mPaint.setColor(res.getColor(R.color.mdtp_numbers_text_color));
        ...
        this.mTransitionMidRadiusMultiplier = (((float) (disappearsOut ? -1 : 1)) * 0.05f) + DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
        this.mTransitionEndRadiusMultiplier = (((float) (disappearsOut ? 1 : -1)) * 0.3f) + DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
