...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, int amOrPm) {
        ...
        this.mPaint.setTypeface(Typeface.create(res.getString(R.string.mdtp_sans_serif), AM));
    ...
    public void onDraw(Canvas canvas) {
        if (getWidth() != 0 && this.mIsInitialized) {
            ...
            int amAlpha = SELECTED_ALPHA_THEME_DARK;
            int amTextColor = this.mAmPmTextColor;
            int pmColor = this.mUnselectedColor;
            int pmAlpha = SELECTED_ALPHA_THEME_DARK;
