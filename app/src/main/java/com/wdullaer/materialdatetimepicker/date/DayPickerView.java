...
public abstract class DayPickerView extends ListView implements OnScrollListener, OnDateChangedListener {
    ...
    protected int mDaysPerWeek = DAYS_PER_WEEK;
    protected int mFirstDayOfWeek;
    protected float mFriction = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    ...
    private static String getMonthAndYearString(CalendarDay day) {
        ...
        return ((BuildConfig.FLAVOR + cal.getDisplayName(SCROLL_HYST_WEEKS, SCROLL_HYST_WEEKS, Locale.getDefault())) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR) + YEAR_FORMAT.format(cal.getTime());
    }
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        if (action != MpegAudioHeader.MAX_FRAME_SIZE_BYTES && action != Utility.DEFAULT_STREAM_BUFFER_SIZE) {
