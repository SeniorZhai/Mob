...
public interface NodeFilter {
    ...
    IndexedNode updateChild(IndexedNode indexedNode, ChildKey childKey, Node node, CompleteChildSource completeChildSource, ChildChangeAccumulator childChangeAccumulator);
