...
public class DiskBasedCache implements Cache {
    ...
    static void writeInt(OutputStream os, int n) throws IOException {
        os.write((n >> 0) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        os.write((n >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        os.write((n >> 16) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        os.write((n >> 24) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
    }
