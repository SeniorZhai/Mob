...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    protected void _writePPFieldName(SerializableString serializableString, boolean z) throws IOException, JsonGenerationException {
        ...
        if (isEnabled(Feature.QUOTE_FIELD_NAMES)) {
            ...
            int i2 = this._outputTail;
            this._outputTail = i2 + 1;
            asQuotedChars[i2] = TokenParser.DQUOTE;
            return;
        }
        writeRaw(asQuotedChars, 0, asQuotedChars.length);
    }
    ...
    protected void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i <= i3) {
            ...
            int i7 = i5 + 1;
            i = i7 + 1;
            this._outputTail = base64Variant.encodeBase64Chunk((((bArr[i5] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) | i6) << 8) | (bArr[i7] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT), this._outputBuffer, this._outputTail);
            maxLineLength--;
            if (maxLineLength <= 0) {
                char[] cArr = this._outputBuffer;
                i5 = this._outputTail;
        ...
        if (i3 > 0) {
            ...
            if (i3 == 2) {
                i5 = i4 + 1;
                maxLineLength |= (bArr[i4] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 8;
            }
    ...
    protected int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (i6 > 2) {
            ...
            i2 = i9 + 1;
            i6 -= 3;
            this._outputTail = base64Variant.encodeBase64Chunk((((bArr[i7] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) | i8) << 8) | (bArr[i9] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT), this._outputBuffer, this._outputTail);
            i7 = maxLineLength - 1;
            if (i7 <= 0) {
                char[] cArr = this._outputBuffer;
                i8 = this._outputTail;
        ...
        i7 = bArr[0] << 16;
        if (1 < i4) {
            i7 |= (bArr[1] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 8;
            i4 = 2;
        } else {
            i4 = 1;
        }
    ...
    protected int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            i5 = i8 + 1;
            i3 += 3;
            this._outputTail = base64Variant.encodeBase64Chunk((((bArr[i6] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) | i7) << 8) | (bArr[i8] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT), this._outputBuffer, this._outputTail);
            i6 = maxLineLength - 1;
            if (i6 <= 0) {
                char[] cArr = this._outputBuffer;
                i7 = this._outputTail;
        ...
        i = bArr[0] << 16;
        if (1 < i4) {
            i6 = ((bArr[1] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 8) | i;
            i = 2;
        } else {
            i6 = i;
            i = 1;
    ...
    private void _prependOrWriteCharacterEscape(char c, int i) throws IOException, JsonGenerationException {
        ...
        if (i >= 0) {
            ...
            cArr2[i2] = 'u';
            if (c > '\u00ff') {
                i3 = (c >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
                i2++;
                cArr2[i2] = HEX_CHARS[i3 >> 4];
                i2++;
                cArr2[i2] = HEX_CHARS[i3 & 15];
                c = (char) (c & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
            } else {
                i2++;
                cArr2[i2] = '0';
                i2++;
            ...
            this._outputHead = this._outputTail;
            if (c > '\u00ff') {
                r1 = (c >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
                i3 = c & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
    ...
    private int _prependOrWriteCharacterEscape(char[] cArr, int i, int i2, char c, int i3) throws IOException, JsonGenerationException {
        ...
        if (i3 >= 0) {
            ...
            if (c > '\u00ff') {
                r1 = (c >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
                r2 = c & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
    ...
    private void _appendCharacterEscape(char c, int i) throws IOException, JsonGenerationException {
        ...
        if (i >= 0) {
            ...
            cArr2[i4] = 'u';
            if (c > '\u00ff') {
                i4 = (c >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
                int i5 = i3 + 1;
