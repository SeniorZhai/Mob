...
public final class Base64Variant implements Serializable {
    ...
    public int decodeBase64Byte(byte b) {
        return b <= Byte.MAX_VALUE ? this._asciiToBase64[b] : BASE64_VALUE_INVALID;
    }
    ...
    public String encode(byte[] bArr, boolean z) {
        ...
        while (i2 <= i3) {
            ...
            int i4 = i + 1;
            i = i4 + 1;
            encodeBase64Chunk(stringBuilder, (((bArr[i2] << 8) | (bArr[i] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 8) | (bArr[i4] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT));
        ...
        if (i > 0) {
            ...
            if (i == 2) {
                ...
                i2 |= (bArr[maxLineLength] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 8;
            }
