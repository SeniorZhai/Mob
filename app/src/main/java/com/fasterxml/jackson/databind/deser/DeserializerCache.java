...
public final class DeserializerCache implements Serializable {
    ...
    protected final ConcurrentHashMap<JavaType, JsonDeserializer<Object>> _cachedDeserializers = new ConcurrentHashMap(64, AdaptiveEvaluator.DEFAULT_BANDWIDTH_FRACTION, 2);
