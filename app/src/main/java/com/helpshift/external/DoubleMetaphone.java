...
public class DoubleMetaphone implements StringEncoder {
    ...
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = new String[]{"L", "R", "N", "M", "B", "H", "F", "V", "W", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR};
    ...
    private int handleGH(java.lang.String r11, com.helpshift.external.DoubleMetaphone.DoubleMetaphoneResult r12, int r13) {
        /*
        r10 = this;
        r9 = 73;
        r6 = 2;
    ...
    L_0x0095:
        ...
        goto L_0x0088;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.helpshift.external.DoubleMetaphone.handleGH(java.lang.String, com.helpshift.external.DoubleMetaphone$DoubleMetaphoneResult, int):int");
    }
    ...
    private int handleJ(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        if (contains(value, index, 4, "JOSE") || contains(value, 0, 4, "SAN ")) {
            if ((index == 0 && charAt(value, index + 4) == TokenParser.SP) || value.length() == 4 || contains(value, 0, 4, "SAN ")) {
                result.append('H');
            } else {
                result.append('J', 'H');
            }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private int handleS(java.lang.String r11, com.helpshift.external.DoubleMetaphone.DoubleMetaphoneResult r12, int r13, boolean r14) {
        /*
        r10 = this;
        r4 = 3;
        r9 = 2;
    ...
    L_0x00d4:
        ...
        goto L_0x00ce;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.helpshift.external.DoubleMetaphone.handleS(java.lang.String, com.helpshift.external.DoubleMetaphone$DoubleMetaphoneResult, int, boolean):int");
    }
