...
public class ToolTipPopup {
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            registerObserver();
            this.mPopupContent.measure(MeasureSpec.makeMeasureSpec(decorWidth, Action.UNDEFINED_DURATION), MeasureSpec.makeMeasureSpec(decorHeight, Action.UNDEFINED_DURATION));
