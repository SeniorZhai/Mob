...
public class AppLinkNavigation {
    ...
    private void sendAppLinkNavigateEventBroadcast(Context context, Intent intent, NavigationResult type, JSONException e) {
        ...
        if (e != null) {
            extraLoggingData.put(Extra.ERROR, e.getLocalizedMessage());
        }
        extraLoggingData.put(GraphResponse.SUCCESS_KEY, type.isSucceeded() ? HSConsts.STATUS_INPROGRESS : HSConsts.STATUS_NEW);
        extraLoggingData.put(MessageColumns.TYPE, type.getCode());
